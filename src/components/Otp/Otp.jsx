  ...
  return (
    <section>
      <div className="container">
        <div className="row">
          <div className="col-lg-6 mt-3 mb-4 d-flex flex-column gap-4 ">
            <img src={LoginLogo} className="login-logo" width={100} height={70} alt="logo-login" />
            <div className="row">
              <div className="col-12">
                <p className="fs-2 mt-4 ">Verify code</p>
              </div>
              <div className="col-12 py-2 mt-2">
                <p className="">For signup keep mobile number with otp</p>
              </div>
              <div className="col">
                <div className="row ">
                  <div
                  ...
                  >
                    <input
                      class="m-2 text-center form-control rounded border-blue"
                      type="text"
                      id="first"
                      maxlength="1"
                    />

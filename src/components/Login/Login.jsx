...
function Login() {
 ...
 <div className='container mt-5 mb-4'>
      ...
      <p className=' mt-5 fs-2 ms-4'>Login</p>
            <p className='ms-3 mt-2'>Login to access your Golobe account</p>
    ...
    >
      ...
      <div className="d-flex justify-content-between mt-3 ms-1 mb-4">

        <MDBCheckbox name='flexCheck' value='' id='flexCheckDefault' label='Remember me' />
        <Link to={"/forgotpassword"} className='text-danger'>Forgot password?</Link>
      </div>
      <Button  className="btn-s mb-4 mt-4">Login</Button>
     
      <div className="text-center">
        <p>Don’t have an account?  <a href="#!" ><Link to={"/signup"} className='text-danger'>Sign up</Link></a></p>
        <p >
            or sign up with:<hr/>
            </p>
        </div>
